...
import pandas as pd
import numpy as np
from utils.hyperparameters import VAL_DATA, BATCH_SIZE, START_FEATURE, END_FEATURE
...
########## pre-processing ##########
## features
feature_names = column_names[START_FEATURE:END_FEATURE]
print('feature names: ', feature_names)
data = np.array(df[feature_names]).astype(np.float32)
print('========================================')
