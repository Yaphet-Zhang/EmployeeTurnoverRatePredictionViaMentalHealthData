# -*- coding: utf-8 -*-
# @Time    : 2022-4-22 12:27
# @Author  : zhangbowen


import torch
from dataset_RNN import get_data
from utils.hyperparameters import BATCH_SIZE, EPOCH, INPUT_SIZE, SEQUENCE_SIZE, HIDDEN_SIZE, NUM_LAYERS, OUTPUT_SIZE, NAME_NET
...
for i in range(EPOCH):
    ...
    for iteration, (inputs, labels) in enumerate(train_loader):
        ...
        inputs = inputs.reshape(-1, SEQUENCE_SIZE, INPUT_SIZE) # for RNN input (batch_size, sequence_size, input_size)
